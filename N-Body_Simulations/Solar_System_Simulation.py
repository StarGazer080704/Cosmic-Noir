...
def main():
    ...
    tEnd = 365.25 * 24 * 3600 * 100  # Simulate for 10 years
    t = 0
    ...
    Bodies = [
        ...
        {"name": "Jupiter", "distance": 7.785e11, "velocity": 1.307e4, "mass": 1.8982e27},
    ...
    with writer.saving(fig, "solar_system_simulation.mp4", 100):
        for i in range(Nt):
            vel += acc_a * dt / 2.0
            pos += vel * dt
            acc_a = acc(pos, mass, G, softening)
